...
var _login = _interopRequireDefault(require("./api/routes/login"));
var _note = _interopRequireDefault(require("./api/routes/note"));
...
app.listen(process.env.PORT, /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        console.log("Server running on port ".concat(process.env.PORT, " \nin ").concat(process.env.NODE_ENV, " mode"));
